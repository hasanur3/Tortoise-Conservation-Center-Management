...
// ✅ Allow only feeding staff
if (!isset($_SESSION['userId']) || $_SESSION['role'] !== 'feeding') {
...
<head>
    ...
    <title>Feeding Staff Dashboard</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
  <div class="container-fluid">
    <a class="navbar-brand fw-bold" href="#">Feeding Staff Dashboard</a>
    <div class="d-flex">
...
<div class="container py-4">
    <h3 class="mb-4">My Assigned Feeding Tasks</h3>
    <div class="row">
        <?php if ($tasksResult->num_rows > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p>No feeding tasks assigned yet.</p>
        <?php endif; ?>
    </div>
</div>
