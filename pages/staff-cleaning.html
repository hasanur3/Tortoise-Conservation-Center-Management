...
<head>
    ...
    <title>Cleaning Staff Dashboard - Tortoise Management</title>
    ...
    <style>
        ...
        /* Badge colors from the previous dashboard */
        .status-pending {
...
<nav id="sidebar" class="sidebar d-flex flex-column">
    <div class="d-flex align-items-center justify-content-between px-3 py-3 border-bottom border-success">
        <span class="fs-4 fw-bold">Cleaning Staff</span>
    ...
    <ul class="nav flex-column mt-3">
        ...
        <li class="nav-item">
            <a href="#" class="nav-link">
                <i class="bi bi-journal-text"></i> <span>Checklist</span>
            </a>
        </li>
...
<main id="mainContent">
    ...
    <div class="container-fluid">
        ...
        <div class="row g-4 mb-5">
            <div class="col-md-6 col-lg-3">
                <div class="card h-100">
                    <div class="card-header">Habitat Cleaning - Zone 1</div>
                    <div class="card-body d-flex flex-column justify-content-between">
                        <div>
                            <span class="badge status-pending rounded-pill px-3 py-2">Pending</span>
                            <p class="card-text mt-3 mb-2 text-muted">Zone 1 (Forest Habitat)</p>
                            <p class="card-text text-muted">09:00 AM - 11:00 AM</p>
                        </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card h-100">
                    <div class="card-header">Water Basin Refill - All Enclosures</div>
                    <div class="card-body d-flex flex-column justify-content-between">
                        <div>
                            <span class="badge status-inprogress rounded-pill px-3 py-2">In progress</span>
                            <p class="card-text mt-3 mb-2 text-muted">All Enclosures</p>
                            <p class="card-text text-muted">11:00 AM - 12:00 PM</p>
                        </div>
             ...
             <div class="col-md-6 col-lg-3">
                <div class="card h-100">
                    <div class="card-header">Waste Disposal - Central Collection</div>
                    <div class="card-body d-flex flex-column justify-content-between">
                        <div>
                            <span class="badge status-completed rounded-pill px-3 py-2">Completed</span>
                            <p class="card-text mt-3 mb-2 text-muted">Waste Management Area</p>
                            <p class="card-text text-muted">02:00 PM - 02:30 PM</p>
                        </div>
                        <div class="d-flex justify-content-between mt-3">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card h-100">
                    <div class="card-header">Sanitation Check - Quarantine</div>
                    <div class="card-body d-flex flex-column justify-content-between">
                        <div>
                            <span class="badge status-pending rounded-pill px-3 py-2">Pending</span>
                            <p class="card-text mt-3 mb-2 text-muted">Quarantine Section</p>
                            <p class="card-text text-muted">03:00 PM - 04:00 PM</p>
                        </div>
                        <div class="d-flex justify-content-between mt-3">
                            <button class="btn btn-primary btn-sm">Start Task</button>
                            <button class="btn btn-success btn-sm">Mark as Complete</button>
        ...
        <div class="card-shift mb-4">
            <p>Monday: <span class="text-success">09:00 AM - 05:00 PM</span></p>
            <p>Tuesday: <span class="day-off">Day Off</span></p>
            <p>Wednesday: <span class="text-success">08:00 AM - 04:00 PM</span></p>
            <p>Thursday: <span class="text-success">08:00 AM - 04:00 PM</span></p>
            <p>Friday: <span class="text-success">09:00 AM - 05:00 PM</span></p>
        </div>

        <h3 class="mb-3">Equipment Checklist</h3>
        <div class="card-notes">
            <ul class="list-unstyled mb-0">
                <li class="text-muted mb-1">Gloves</li>
                <li class="text-muted mb-1">Disinfectant</li>
                <li class="text-muted mb-1">Scrub Brushes</li>
                <li class="text-muted mb-1">Waste Bins</li>
            </ul>
        </div>
    </div>
</main>
...
<script>
    // This JavaScript is for the sidebar toggle functionality
