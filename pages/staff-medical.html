...
<head>
    ...
    <title>Medical Staff Dashboard - Tortoise Management</title>
...
<nav id="sidebar" class="sidebar d-flex flex-column">
    <div class="d-flex align-items-center justify-content-between px-3 py-3 border-bottom border-success">
        <span class="fs-4 fw-bold">Medical Staff</span>
    ...
    <ul class="nav flex-column mt-3">
        ...
        <li class="nav-item">
            <a href="#" class="nav-link">
                <i class="bi bi-journal-text"></i> <span>Patient Records</span>
            </a>
        </li>
...
<main id="mainContent">
    ...
    <div class="container-fluid">
        ...
        <div class="row g-4 mb-5">
            <div class="col-md-6 col-lg-3">
                <div class="card h-100">
                    <div class="card-header">Daily Health Check - Tortoise ID 001</div>
                    <div class="card-body d-flex flex-column justify-content-between">
                        <div>
                            ...
                            <p class="card-text text-muted">09:30 AM - 10:00 AM</p>
                        </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card h-100">
                    <div class="card-header">Medication Admin - Tortoise ID 007</div>
                    <div class="card-body d-flex flex-column justify-content-between">
                        <div>
                            <span class="badge status-inprogress rounded-pill px-3 py-2">In progress</span>
                            <p class="card-text mt-3 mb-2 text-muted">Recovery Pen 1</p>
                            <p class="card-text text-muted">11:00 AM - 11:30 AM</p>
                        </div>
             ...
             <div class="col-md-6 col-lg-3">
                <div class="card h-100">
                    <div class="card-header">Routine Checkup - Tortoise ID 012</div>
                    <div class="card-body d-flex flex-column justify-content-between">
                        <div>
                            <span class="badge status-pending rounded-pill px-3 py-2">Pending</span>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card h-100">
                    <div class="card-header">Post-Surgery Monitoring - Tortoise ID 003</div>
                    <div class="card-body d-flex flex-column justify-content-between">
                        <div>
                            <span class="badge status-overdue rounded-pill px-3 py-2">Overdue</span>
                            <p class="card-text mt-3 mb-2 text-muted">Intensive Care Unit</p>
        ...
        <div class="card-shift mb-4">
            <p>Monday: <span class="text-success">10:00 AM - 06:00 PM</span></p>
            <p>Tuesday: <span class="text-success">10:00 AM - 06:00 PM</span></p>
            <p>Wednesday: <span class="text-success">10:00 AM - 06:00 PM</span></p>
            <p>Thursday: <span class="day-off">Day Off</span></p>
            <p>Friday: <span class="text-success">09:00 AM - 05:00 PM</span></p>
        </div>

        <h3 class="mb-3">Urgent Medical Cases</h3>
        <div class="card-notes">
            <ul class="list-unstyled mb-0">
                <li class="text-danger mb-1">Tortoise ID 003 (Post-surgery)</li>
                <li class="text-danger mb-1">Tortoise ID 015 (Respiratory issue)</li>
            </ul>
             <button class="btn btn-danger w-100 mt-3">View All Patient Records</button>
        </div>
    </div>
</main>
