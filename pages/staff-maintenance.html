...
<head>
    ...
    <title>Maintenance Staff Dashboard - Tortoise Management</title>
...
<nav id="sidebar" class="sidebar d-flex flex-column">
    <div class="d-flex align-items-center justify-content-between px-3 py-3 border-bottom border-success">
        <span class="fs-4 fw-bold">Maintenance Staff</span>
    ...
    <ul class="nav flex-column mt-3">
        ...
        <li class="nav-item">
            <a href="#" class="nav-link">
                <i class="bi bi-journal-text"></i> <span>Work Orders</span>
            </a>
        </li>
...
<main id="mainContent">
    ...
    <div class="container-fluid">
        ...
        <div class="row g-4 mb-5">
            <div class="col-md-6 col-lg-3">
                <div class="card h-100">
                    <div class="card-header">Enclosure Fence Repair - Zone 2</div>
                    <div class="card-body d-flex flex-column justify-content-between">
                        <div>
                            <span class="badge status-pending rounded-pill px-3 py-2">Pending</span>
                            <p class="card-text mt-3 mb-2 text-muted">Zone 2 (Desert Habitat)</p>
                            <p class="card-text text-muted">08:30 AM - 10:30 AM</p>
                        </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card h-100">
                    <div class="card-header">Irrigation System Check - Greenhouse</div>
                    <div class="card-body d-flex flex-column justify-content-between">
                        <div>
                            <span class="badge status-inprogress rounded-pill px-3 py-2">In progress</span>
                            <p class="card-text mt-3 mb-2 text-muted">Greenhouse Section</p>
                            <p class="card-text text-muted">10:30 AM - 12:00 PM</p>
                        </div>
             ...
             <div class="col-md-6 col-lg-3">
                <div class="card h-100">
                    <div class="card-header">Light Fixture Replacement - Medical Bay</div>
                    <div class="card-body d-flex flex-column justify-content-between">
                        <div>
                            ...
                            <p class="card-text text-muted">02:00 PM - 02:45 PM</p>
                        </div>
                        <div class="d-flex justify-content-between mt-3">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card h-100">
                    <div class="card-header">HVAC Filter Change - Main Building</div>
                    <div class="card-body d-flex flex-column justify-content-between">
                        <div>
                            <span class="badge status-pending rounded-pill px-3 py-2">Pending</span>
                            <p class="card-text mt-3 mb-2 text-muted">Admin Building</p>
                            <p class="card-text text-muted">03:00 PM - 04:30 PM</p>
                        </div>
                        <div class="d-flex justify-content-between mt-3">
                            <button class="btn btn-primary btn-sm">Start Task</button>
                            <button class="btn btn-success btn-sm">Mark as Complete</button>
        ...
        <div class="card-shift mb-4">
            <p>Monday: <span class="text-success">08:30 AM - 04:30 PM</span></p>
            <p>Tuesday: <span class="text-success">08:30 AM - 04:30 PM</span></p>
            <p>Wednesday: <span class="day-off">Day Off</span></p>
            <p>Thursday: <span class="text-success">08:30 AM - 04:30 PM</span></p>
            <p>Friday: <span class="text-success">08:30 AM - 04:30 PM</span></p>
        </div>

        <h3 class="mb-3">Pending Requests</h3>
        <div class="card-notes">
            <ul class="list-unstyled mb-0">
                <li class="text-danger mb-1">Broken gate in Enclosure A</li>
                <li class="text-danger mb-1">Faulty sensor in Zone 3</li>
            </ul>
             <button class="btn btn-primary w-100 mt-3">Report New Issue</button>
        </div>
    </div>
</main>
