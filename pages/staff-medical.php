...
// ✅ Allow only medical staff
if (!isset($_SESSION['userId']) || $_SESSION['role'] !== 'medical') {
...
// Fetch tasks assigned to this medical staff
...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
  <div class="container-fluid">
    <a class="navbar-brand fw-bold" href="#">Medical Staff Dashboard</a>
    <div class="d-flex">
...
<div class="container py-4">
    <h3 class="mb-4">My Assigned Medical Tasks</h3>
    <div class="row">
        <?php if ($tasksResult->num_rows > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p>No medical tasks assigned yet.</p>
        <?php endif; ?>
    </div>
</div>
